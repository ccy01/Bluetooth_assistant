...
public class BluetoothChatService {
    ...
    public synchronized void start() {
        ...
        if (mAcceptThread == null) {//重新接受
            mAcceptThread = new AcceptThread();
            mAcceptThread.start();
        }
        setState(STATE_LISTEN);//每一次都是状态改变
    }
    ...
    public synchronized void connected(BluetoothSocket socket, BluetoothDevice device) {
        ...
        bundle.putString(ChatActivity.DEVICE_ADDRESS, device.getAddress());
        msg.setData(bundle);
    ...
    private void connectionFailed() {
        ...
        Bundle bundle = new Bundle();
        bundle.putString(ChatActivity.TOAST, "无法连接设备请重试");
        msg.setData(bundle);
        mHandler.sendMessage(msg);
    }
    ...
    private void connectionLost() {
        ...
        Message msg = mHandler.obtainMessage(ChatActivity.MESSAGE_TOAST);
        Bundle bundle = new Bundle();
        bundle.putString(ChatActivity.TOAST, "连接丢失");
        msg.setData(bundle);
        mHandler.sendMessage(msg);
        start();
